                ...
                <div class="flex-1 bg-white rounded-lg shadow-xl p-8">
                    ...
                    <ul class="mt-2 text-gray-700">
                        ...
                        <li class="flex border-b py-2">
                            ...
                            <span class="text-gray-700">{{ $user->profile->Birthday }}</span>
                        </li>
                        <li class="flex border-b py-2">
                        ...
                        <li class="flex border-b py-2">
                            ...
                            <span class="text-gray-700">{{ $user->profile->mobile }}</span>
                        </li>
                        <li class="flex border-b py-2">
                        ...
                        <li class="flex items-center border-b py-2 space-x-2">
                            ...
                            <a href="{{ $user->profile->facebook }}" title="Facebook">
                            ...
                            <a href="{{ $user->profile->instagram }}" title="Twitter">
                            ...
                            <a href="{{ $user->profile->linkedin }}" title="LinkedIn">
                                <svg class="w-5 h-5" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 333333 333333"
                                    shape-rendering="geometricPrecision" text-rendering="geometricPrecision"
                                    image-rendering="optimizeQuality" fill-rule="evenodd" clip-rule="evenodd">
                                    <path
                            ...
                            <a href="{{ $user->profile->github }}" title="Github">
